...
const HelpSupport = () => {
  ...
  const ModuleFAQPage = ({ moduleId }) => {
    ...
    return (
      <div className="space-y-6">
        ...
        {/* Search Bar - Fixed: Allows free text input without selection issues */}
  ...
  // Main Page
  if (currentPage === 'main') {
    // Get suggestions based on search - fixed to work properly
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="p-6 max-w-6xl mx-auto">
            ...
            <div className="text-center mb-8">
              <p className="text-xl text-green-500 mb-1">Hi {userData?.user?.full_name || 'User'},</p>
              <h1 className="text-4xl font-bold text-gray-900 mb-2">How can we help you?</h1>
            </div>

            {/* Search Section - Fixed: Allows free text input */}
                  ...
                  {suggestions.map((suggestion, index) => (
                    <button
                      ...
                      onClick={() => {
                        ...
                        setShowSuggestions(false);
                        // Find and navigate to the module containing this FAQ
