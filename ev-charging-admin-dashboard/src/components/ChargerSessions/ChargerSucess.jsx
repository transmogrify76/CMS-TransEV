      ...
      <div className="min-h-screen bg-gray-50 flex">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600">No charger data found</p>
            <button
              onClick={() => navigate('/add-charger')}
            ...
            <div className="mt-6 bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="ml-auto px-4 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition flex items-center gap-2 shadow-lg shadow-blue-500/25"
                >
                  <Share2 className="w-4 h-4" />
                  Share
                </button>
